...
// 🔴 FIX: Render ke proxy ke peeche chal rahe ho — isse X-Forwarded-For
// warning fix hoga aur rate-limit sahi client IP detect karega
app.set('trust proxy', 1);

// 🔴 FIX: ETag disable — GET responses pe 304 caching band, taaki
// admin panel/mobile app ko hamesha fresh data mile
app.set('etag', false);
